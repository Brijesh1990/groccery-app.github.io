					...
					<div class="product-sec1">
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="productdetails.php" class="link-product-add-cart">Quick View</a>
										</div>
									</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Zeeba Basmati Rice</a>
									</h4>
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Maiyas Gulab Jamun</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Lipton Green Tea</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Organicana Red Chilli</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">MTR Black Pepper</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Chataka - Elaichi</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Narulag, Less Sugar</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Kellogg's Chocos Fills</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Amul's India</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Snickers Chocolates</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">Kissan Fruit Jam</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="productdetails.php">MTR Vegetable Pickle</a>
									</h4>
									<div class="info-product-price">
				...
				<ul id="flexiselDemo1">
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="productdetails.php">Aashirvaad, 5g</a>
								</h4>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="productdetails.php">Kissan Tomato Ketchup, 950g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$99.00</h6>
									<p>Save $20.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="productdetails.php">Madhur Pure Sugar, 1g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$69.00</h6>
									<p>Save $20.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="productdetails.php">Cadbury Choclairs, 655.5g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$160.00</h6>
									<p>Save $60.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="productdetails.php">Sprite, 2.25L (Pack of 2)</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$180.00</h6>
									<p>Save $30.00</p>
